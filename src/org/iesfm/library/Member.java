...
public class Member {
    ...
    public void info() {
        System.out.println("Información de los socios de la biblioteca:");
        System.out.println(name + " " + surnames + ".DNI " + nif + ". CP " + cp + " . Y numero de socio " + numMember);
    }
    ...
    public boolean equals(Object o) {
        ...
        return numMember == member.numMember &&
                cp == member.cp &&
                Objects.equals(nif, member.nif) &&
                Objects.equals(name, member.name) &&
                Objects.equals(surnames, member.surnames);
    }
